...
function snakeMove(){
    ...
    for(i = snakeBody.length - 2; i >= 0; i--){               //because i value is greater
           snakeBody[i+1] ={...snakeBody[i]}                 //targetting second last element
    }
...
function getFoodrandomPosition(){
    ...
    return {x : a,  y : b};                     //to give random positions to fruit
}
